...
ANDROID_APP_ID="com.nuviox.mobile.debug"
...
Builds the debug app for Android, installs it on all available Android
emulators or connected physical devices, and launches the app.
EOF
}
