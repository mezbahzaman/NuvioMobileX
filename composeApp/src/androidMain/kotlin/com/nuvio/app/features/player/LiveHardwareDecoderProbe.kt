...
import com.nuvio.app.core.analytics.LiveHardwareDecoderPolicy
 ...
 * the stream's codec or resolution. Probed once and cached. (Android phones default to libmpv, so
 * this only bites for users who explicitly picked Auto/ExoPlayer.)
 */
object LiveHardwareDecoderProbe {

    @Volatile private var cached: Boolean? = null

    /** True when live should default to libmpv on this device. The decision itself lives in the
     *  pure, unit-tested [LiveHardwareDecoderPolicy]; this only supplies the device's decoder name. */
